...
class AboutMe {
  constructor() {
    ...
    this.skills = ["HTML", "CSS", "JavaScript", "React", "Node.js", "Python"];
    this.tools = ["VSCode", "Git", "Linux", "Figma"];
  }
}
```

- 🔭 I’m currently working on **modern web applications**
- 🌱 I’m currently learning **advanced backend & deployment**
- 💬 Ask me about **frontend frameworks, responsive design, or full-stack development**
- 📫 How to reach me: **coming soon...**
- ⚡ Fun fact: I love building sleek UI and solving real-world problems with code.
